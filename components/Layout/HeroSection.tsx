...
const HeroSection = () => {
    return (
        <section className="padding w-full h-screen text-white linear-blue_1 flex items-center flex-col md:flex-row overflow-hidden gap-5">
            ...
            <div className='w-[200px] h-[200px] md:w-[480px] md:h-[480px] basis-full md:basis-2/5 overflow-hidden relative'>
